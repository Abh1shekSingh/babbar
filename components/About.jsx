...
const About = () => {
  const work = [...("Showcase.")];
  return (
    <section className='p-14 sm:p-24 w-full z-2 min-h-screen bg-dark rounded-t-3xl '>
      <div>
      ...
      <div className='xl:gap-x-18 grid pt-12 grid-cols-1 gap-x-14 gap-y-10 pb-20 md:grid-cols-12 md:gap-y-20 2xl:gap-x-20 3xl:gap-x-24'>
        <div className='col-span-7'>
          <Link href='/'>
            <div className='mb-4 overflow-hidden rounded transition-all duration-300 group-hover:rounded-xl xl:mb-5 2xl:mb-6 3xl:mb-7 '>
        ...
        <div className='xl:col-span-5 col-span-7 xl:pt-[5rem]'>
          <Link href='/'>
            <div className='mb-4 overflow-hidden rounded transition-all duration-300 group-hover:rounded-xl xl:mb-5 2xl:mb-6 3xl:mb-7 '>
              <Image src={codeforces} alt='leetcode' />
            </div>
            <div className=' mt-3 flex flex-col justify-between  gap-y-4 @lg:flex-row'>
              <h3 className='w-fit text-light text-lg font-bold text-accent-300 2xl:text-3xl 3xl:text-3xl'>Leetcode</h3>
            </div>
        ...
        <div className='xl:col-span-5 col-span-7 xl:pt-[5rem]'>
          <Link href='/'>
            <div className='mb-4 overflow-hidden rounded transition-all duration-300 group-hover:rounded-xl xl:mb-5 2xl:mb-6 3xl:mb-7 '>
              <Image src={kickstart} alt='leetcode' />
            </div>
            <div className=' mt-3 flex flex-col justify-between  gap-y-4 @lg:flex-row'>
              <h3 className='w-fit text-light text-lg font-bold text-accent-300 2xl:text-3xl 3xl:text-3xl'>Leetcode</h3>
            </div>
